...
<td>
    ...
    <img  src='<%=pic%>' height='60' width='60' /></td>
<td>User Name</td>
</tr>
<tr>
...
<div class="span9">
<!--form action="afterprofile.jsp" method="post"-->
...
<tr><td>Last Name</td>
<td><input type="text" name="lname" required="true" class="span3" placeholder="Last Name" value="<% out.print(lname); %>" />
</td></tr>
<tr><td>DOB</td>
<td class="span3">
...
<tr><td>Gender</td>
<td><input type="radio" name="sex" value="Male" value="<% out.print(sex); %>"/>Male
<input type="radio" name="sex" value="Female" value="<% out.print(sex); %>" />Female
</td></tr>

<tr><td>Mobile Phones</td>
...
<tr><td>Address</td>
<td><textarea rows="3" cols="60" name="address" placeholder="Address" class="span3" value="<% out.print(address); %>"></textarea></td></tr>
<tr><td>Website</td>
    <td><input type="text" class="span3" name="website" placeholder="Website" value="<%out.print(website);%>" /></td></tr>
    <tr><td>About Me</td>
        <td><textarea  rows="3" cols="60" name="aboutme" class="span3" placeholder="About Me" value="<% out.print(aboutme); %>"></textarea>
        </td></tr>
...
<table class="table">
<tr>
<td><img src="images/hackman.gif" height="60" width="60" /></td>
<td>User Name</td>
</tr>
<tr>
...
<tr><td>First Name</td>
    <td><input type="text" name="fname" required="true" class="span3" placeholder="First Name" value="" />
</td></tr>
<tr><td>Last Name</td>
<td><input type="text" name="lname" required="true" class="span3" placeholder="Last Name" value="" />
</td></tr>
<tr><td>DOB</td>
<td class="span3">
<select style="width:80px" name="day">
...
<tr><td>Gender</td>
<td><input type="radio" name="sex" value="Male" value=""/>Male
<input type="radio" name="sex" value="Female" value="" />Female
</td></tr>

<tr><td>Mobile Phones</td>
<td><input tabindex="text" class="span3" maxlength="10" name="phone" placeholder="Mobile Phones" value="" /></td></tr>
<tr><td>Current City</td>
    <td><input title="text" class="span3" name="ccity" placeholder="Current City"value="" />
</td></tr>
<tr><td>country</td>
<td><select style="width:280px" name="country" value="">
<option value="--"> - - Select a country - - </option>
<option value="AF">Afghanistan</option>
<option value="AX">Åland Islands</option>
<option value="AL">Albania</option>
...
<tr><td>Address</td>
<td><textarea rows="3" cols="60" name="address" placeholder="Address" class="span3" value=""></textarea></td></tr>
<tr><td>Website</td>
    <td><input type="text" class="span3" name="website" placeholder="Website" /></td></tr>
    <tr><td>About Me</td>
        <td><textarea  rows="3" cols="60" name="aboutme" class="span3" placeholder="About Me"> </textarea>
        </td></tr>
    <tr><td><button class="btn btn-info" type="submit">Save</button></td>
        <td><button class="btn btn-error" type="submit">Cancel</button></td></tr>
</table>
...
Title<input type="text" name="title" align="center"></input>
