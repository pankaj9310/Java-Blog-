...
out.print(rs.getString("blogdetail").substring(0, 215));
    ...
    <tr><td>
            ...
            <img src="images/user.jpg" width="30" height="30" align="left" alt="" style=" margin: 3px"/></td><td>
             <a href="#?user=<% out.print(rs7.getString("username"));%>"><% out.print(rs7.getString("username")); %></a>
    <%
 }
    %>
...
%>
        <a href="blog.jsp?blogid=<% out.print(rs.getString("blogid"));%>">Read more....</a></p>
    </div>
