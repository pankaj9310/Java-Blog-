...
%>
 <div class="modal-header">
                    <h3 id="myModalLabel"><center>User Details.</center></h3>
</div>
 <table class=" table table-bordered">
      <tr>
...
%>
                 ...
                 </td><td><a href="view.jsp">View</a></td>
                
              <td><i class="icon-remove"></i><a href="delete.jsp?user=<% out.print(rs.getString("username"));%>">Delete</a></td></tr>
